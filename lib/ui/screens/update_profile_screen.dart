...
import 'package:task_manager_oly/data/models/user_model.dart';
import 'package:task_manager_oly/ui/controllers/auth_controller.dart';
import 'package:task_manager_oly/ui/widgets/background_widget.dart';
...
class _UpdateProfileScreenState extends State<UpdateProfileScreen> {
  ...
  Future<void> _updateProfile() async {
    ...
    if (response.isSuccess && response.responseData['status'] == 'success') {
      ...
      if (mounted) {
        showSnackBarMessage(
            context, response.errorMassege ?? 'Profile Update Failed! Try Again');
      }
    }
  ...
  Future<void> _pickProfileImage() async {
    ...
    final XFile? result = await imagePicker.pickImage(
        source: ImageSource.camera); //gallary niye dkhbo pore
    if (result != null) {
